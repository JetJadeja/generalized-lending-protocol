...
contract FusePoolTest is DSTestPlus {
    ...
    function testNewAssetConfiguration() public {
        ...
        pool.configureAsset(newAsset, newVault, FusePool.Configuration(0.6e18, 0));
    ...
    function testUpdateConfiguration() public {
        pool.updateConfiguration(asset, FusePool.Configuration(0.9e18, 0)); 
    ...
    function testUserLiquidatable(uint256 amount) public {
        ...
        pool.updateConfiguration(borrowAsset, FusePool.Configuration(0.5e18, 1e18)); 
